...
\aboutme{
\textbf{Systems Engineer} with extensive knowledge and experience in \textbf{Software Engineering} and \textbf{Software Development} for enterprise applications. Contributed to key software applications across diverse markets, including banking, healthcare, and the airline industry to support flight operations. Honest, easy to work with, self-motivated with strong self-learning skills. I have a keen interest in \textbf{cloud practices} \textbf{infrastructure} \textbf{design} and \textbf{software architecture} I’ve had the opportunity to work on highly critical software projects, which I find both challenging and rewarding.}%About me section

...
\twentyitem
    ...
    {Valtech}
    {As a consultant, I worked with Google Partners to implement artificial intelligence (AI) solutions for retail clients, introducing a range of new features to their online stores that enhanced the customer experience. Application maintenance for key banking systems in major U.S. banks. }
\twentyitem
    {2018 - 2023}
